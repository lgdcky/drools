...
public final class TypeConvertTools {
    ...
    public static byte[] ObjMapToBytesByFastJson(Object object) throws UnsupportedEncodingException {
        long star = System.currentTimeMillis();
        byte[] bytes = jsonArray.toJSONString(object,serializeConfig).getBytes("UTF-8");
        System.out.println(System.currentTimeMillis() - star + " ObjMapToBytesByFastJson");
        return bytes;
    }
